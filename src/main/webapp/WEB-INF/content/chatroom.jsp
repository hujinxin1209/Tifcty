...
<body>
    ...
    $(document).ready(function() {
        ...
        if ('WebSocket' in window) {
			websocket = new WebSocket("ws://localhost:8080/Tifcty/ws?uid="+${sessionScope.uid});
		} else if ('MozWebSocket' in window) {
			websocket = new MozWebSocket("ws://localhost:8080/Tifcty/ws"+${sessionScope.uid});
		} else {
			websocket = new SockJS("http://localhost:8080/Tifcty/ws/sockjs"+${sessionScope.uid});
		}
        //var websocket = new WebSocket('ws://localhost:8080/Tifcty/ws');
